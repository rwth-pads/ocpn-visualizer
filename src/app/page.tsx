      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        ...
        <Collapse in={menuOpen} timeout="auto" unmountOnExit>
          <Box sx={{ width: '100%', bgcolor: 'background.paper' }}>
            ...
            >
              ...
              <Tab label="OCPN Specific Options" />
              <Tab label="Editor" />
            </Tabs>
          </Box>
        </Collapse>
        <Box
          sx={{
            flexGrow: 1,
            display: 'grid',
            gridTemplateColumns: tabValue === 0 || isSmallScreen ? '1fr' : '1fr 1fr',
            gap: 2,
            p: 2,
          }}
        >
          {tabValue !== 0 && (
            ...
            >
              ...
              {tabValue === 2 && <Typography variant="h6">OCPN Specific Options</Typography>}
          ...
          {(tabValue === 0 || !isSmallScreen) && (
            ...
            >
              ...
              {tabValue === 0 && <Typography variant="h6">Visualization</Typography>}
            </Box>
          )}
        </Box>
      </Box>
